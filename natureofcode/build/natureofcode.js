...
define('vectors/../../../src/././utils/Color',["require", "exports"], function(require, exports) {
    var Color = (function () {
        function Color() {
        }
...
define('vectors/../../../src/./pgraphics',["require", "exports", "./utils/Color"], function(require, exports, __colorUtils__) {
...
define('vectors/../../../src/./pmath',["require", "exports"], function(require, exports) {
    var PMath = (function () {
        function PMath() {
        }
        PMath.init = function () {
...
define('vectors/../../../src/./pvector',["require", "exports"], function(require, exports) {
...
define('vectors/../../../src/./utils/events',["require", "exports"], function(require, exports) {
    var Events = (function () {
        function Events() {
        }
...
define('vectors/../../../src/./utils/extensions',["require", "exports"], function(require, exports) {
...
define('vectors/../../../src/sketch',["require", "exports", "./pgraphics", "./pmath", "./pvector", "./utils/events", "./utils/extensions"], function(require, exports, __graphics__, __math__, __vector__, __events__, __extensions__) {
...
define('vectors/bouncingBall',["require", "exports", "../../../src/sketch", "../../../src/pvector"], function(require, exports, __Sketch__, __PVector__) {
...
define('vectors/vectorSubtraction',["require", "exports", "../../../src/sketch", "../../../src/pvector"], function(require, exports, __Sketch__, __PVector__) {
    var Sketch = __Sketch__;
    var PVector = __PVector__;
...
define('vectors/vectorMultiplication',["require", "exports", "../../../src/sketch", "../../../src/pvector"], function(require, exports, __Sketch__, __PVector__) {
    var Sketch = __Sketch__;
    var PVector = __PVector__;
...
define('vectors/vectorNormalization',["require", "exports", "../../../src/sketch", "../../../src/pvector"], function(require, exports, __Sketch__, __PVector__) {
    var Sketch = __Sketch__;
    var PVector = __PVector__;
...
define('vectors/mover',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
...
define('vectors/motionVelocity',["require", "exports", "../../../src/sketch", "./mover"], function(require, exports, __Sketch__, __Mover__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;
    ...
    var MotionVelocity = (function (_super) {
        ...
        MotionVelocity.prototype.draw = function () {
            background(255);
...
define('vectors/Mover2',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
    ...
    var Mover2 = (function () {
        ...
        Mover2.prototype.display = function () {
            fill(0);
            ellipse(this.position.x, this.position.y, 20);
        };

        Mover2.prototype.checkEdges = function () {
            if (this.position.x > width) {
                this.position.x = 0;
            } else if (this.position.x < 0) {
                this.position.x = width;
...
define('vectors/constantAcceleration',["require", "exports", "../../../src/sketch", "./Mover2"], function(require, exports, __Sketch__, __Mover2__) {
    var Sketch = __Sketch__;
    var Mover2 = __Mover2__;
    ...
    var ConstantAcceleration = (function (_super) {
        ...
        ConstantAcceleration.prototype.draw = function () {
            background(255);
...
define('vectors/mover3',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
    ...
    var Mover3 = (function () {
        ...
        Mover3.prototype.display = function () {
            fill(0);
            ellipse(this.position.x, this.position.y, 20);
        };

        Mover3.prototype.checkEdges = function () {
            if (this.position.x > width) {
                this.position.x = 0;
            } else if (this.position.x < 0) {
                this.position.x = width;
...
define('vectors/randomAcceleration',["require", "exports", "../../../src/sketch", "./mover3"], function(require, exports, __Sketch__, __Mover3__) {
    var Sketch = __Sketch__;
    var Mover3 = __Mover3__;
    ...
    var RandomAcceleration = (function (_super) {
        ...
        RandomAcceleration.prototype.draw = function () {
            background(255);
...
define('vectors/mover4',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
    ...
    var Mover4 = (function () {
        ...
        Mover4.prototype.display = function () {
            fill(0);
            ellipse(this.position.x, this.position.y, 20);
        };

        Mover4.prototype.checkEdges = function () {
            if (this.position.x > width) {
                this.position.x = 0;
            } else if (this.position.x < 0) {
                this.position.x = width;
...
define('vectors/accelerateTowardsMouse',["require", "exports", "../../../src/sketch", "./mover4"], function(require, exports, __Sketch__, __Mover4__) {
    var Sketch = __Sketch__;
    var Mover4 = __Mover4__;
    ...
    var AccelerateTowardsMouse = (function (_super) {
        ...
        AccelerateTowardsMouse.prototype.draw = function () {
            background(255);
...
define('vectors/multipleAccelerateTowardsMouse',["require", "exports", "../../../src/sketch", "./mover4"], function(require, exports, __Sketch__, __Mover4__) {
    var Sketch = __Sketch__;
    var Mover4 = __Mover4__;
    ...
    var MultipleAccelerateTowardsMouse = (function (_super) {
        ...
        MultipleAccelerateTowardsMouse.prototype.draw = function () {
            background(255);
...
define('forces/../../../src/././utils/Color',["require", "exports"], function(require, exports) {
    var Color = (function () {
        function Color() {
        }
        Color.float32ColorToARGB = function (float32Color) {
...
define('forces/../../../src/./pgraphics',["require", "exports", "./utils/Color"], function(require, exports, __colorUtils__) {
    var colorUtils = __colorUtils__;
...
define('forces/../../../src/./pmath',["require", "exports"], function(require, exports) {
    var PMath = (function () {
        function PMath() {
        }
        PMath.init = function () {
...
define('forces/../../../src/./pvector',["require", "exports"], function(require, exports) {
    var PVector = (function () {
        function PVector(x, y) {
            this.x = x;
            this.y = y;
...
define('forces/../../../src/./utils/events',["require", "exports"], function(require, exports) {
    var Events = (function () {
        function Events() {
        }
        Events.addEventListener = function (obj, evt, fnc) {
...
define('forces/../../../src/./utils/extensions',["require", "exports"], function(require, exports) {
    var Extensions = (function () {
        function Extensions() {
        }
        Extensions.init = function () {
...
define('forces/../../../src/sketch',["require", "exports", "./pgraphics", "./pmath", "./pvector", "./utils/events", "./utils/extensions"], function(require, exports, __graphics__, __math__, __vector__, __events__, __extensions__) {
    var graphics = __graphics__;
    var math = __math__;
    var vector = __vector__;
    var events = __events__;
...
define('forces/mover',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
...
define('forces/forces',["require", "exports", "../../../src/sketch", "./mover", "../../../src/pvector"], function(require, exports, __Sketch__, __Mover__, __PVector__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;
    var PVector = __PVector__;
    ...
    var Forces = (function (_super) {
        ...
        Forces.prototype.draw = function () {
            background(255);
...
define('forces/gravityScaledByMass',["require", "exports", "../../../src/sketch", "./mover", "../../../src/pvector"], function(require, exports, __Sketch__, __Mover__, __PVector__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;
    var PVector = __PVector__;
    ...
    var GravityScaledByMass = (function (_super) {
        ...
        GravityScaledByMass.prototype.draw = function () {
            background(255);
...
define('forces/includingFriction',["require", "exports", "../../../src/sketch", "./mover", "../../../src/pvector"], function(require, exports, __Sketch__, __Mover__, __PVector__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;
    var PVector = __PVector__;
    ...
    var IncludingFriction = (function (_super) {
        ...
        IncludingFriction.prototype.draw = function () {
            background(255);
...
define('forces/liquid',["require", "exports"], function(require, exports) {
    var Liquid = (function () {
...
define('forces/mover2',["require", "exports", "../../../src/pvector", "./mover", "./liquid"], function(require, exports, __PVector__, __Mover__, __Liquid__) {
    var PVector = __PVector__;
    var Mover = __Mover__;
    var Liquid = __Liquid__;
    ...
    var Mover2 = (function (_super) {
        ...
        Mover2.prototype.isInside = function (l) {
        ...
        Mover2.prototype.drag = function (l) {
...
define('forces/fluidResistance',["require", "exports", "../../../src/sketch", "./mover2", "../../../src/pvector", "./liquid"], function(require, exports, __Sketch__, __Mover__, __PVector__, __Liquid__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;
    var PVector = __PVector__;
    var Liquid = __Liquid__;
    ...
    var FluidResistance = (function (_super) {
        ...
        FluidResistance.prototype.draw = function () {
            background(255);
...
define('forces/Attractor',["require", "exports", "./mover", "../../../src/pvector"], function(require, exports, __Mover__, __PVector__) {
    var Mover = __Mover__;
    var PVector = __PVector__;
...
define('forces/attraction',["require", "exports", "../../../src/sketch", "./mover", "../../../src/pvector", "./Attractor"], function(require, exports, __Sketch__, __Mover__, __PVector__, __Attractor__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;
    var PVector = __PVector__;
    var Attractor = __Attractor__;
...
define('forces/attractionManyMovers',["require", "exports", "../../../src/sketch", "./mover", "../../../src/pvector", "./Attractor"], function(require, exports, __Sketch__, __Mover__, __PVector__, __Attractor__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;
    var PVector = __PVector__;
    var Attractor = __Attractor__;

    var AttractionManyMovers = (function (_super) {
        __extends(AttractionManyMovers, _super);
        function AttractionManyMovers() {
            _super.apply(this, arguments);
        }
        AttractionManyMovers.prototype.setup = function () {
            this.movers = [];
        ...
        AttractionManyMovers.prototype.draw = function () {
            background(255);
...
define('forces/mover3',["require", "exports", "../../../src/pvector", "./mover", "./liquid"], function(require, exports, __PVector__, __Mover__, __Liquid__) {
    var PVector = __PVector__;
    var Mover = __Mover__;
    var Liquid = __Liquid__;
    ...
    var Mover3 = (function (_super) {
        ...
        function Mover3(mass, x, y) {
            _super.call(this, mass, x, y);

            this.G = 0.4;
        }
        Mover3.prototype.attract = function (m) {
            var force = PVector.sub(this.position, m.position);
            var distance = force.mag();
            distance = constrain(distance, 5.0, 25.0);
...
define('forces/mutualAttraction',["require", "exports", "../../../src/sketch", "./mover3", "../../../src/pvector"], function(require, exports, __Sketch__, __Mover__, __PVector__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;
    var PVector = __PVector__;

    var MutualAttraction = (function (_super) {
        __extends(MutualAttraction, _super);
        function MutualAttraction() {
            _super.apply(this, arguments);
        }
        MutualAttraction.prototype.setup = function () {
            this.movers = [];
        ...
        MutualAttraction.prototype.draw = function () {
            background(255);
...
define('oscillation/../../../src/././utils/Color',["require", "exports"], function(require, exports) {
    var Color = (function () {
        function Color() {
        }
        Color.float32ColorToARGB = function (float32Color) {
...
define('oscillation/../../../src/./pgraphics',["require", "exports", "./utils/Color"], function(require, exports, __colorUtils__) {
    var colorUtils = __colorUtils__;
...
define('oscillation/../../../src/./pmath',["require", "exports"], function(require, exports) {
    var PMath = (function () {
        function PMath() {
        }
        PMath.init = function () {
...
define('oscillation/../../../src/./pvector',["require", "exports"], function(require, exports) {
    var PVector = (function () {
        function PVector(x, y) {
            this.x = x;
            this.y = y;
...
define('oscillation/../../../src/./utils/events',["require", "exports"], function(require, exports) {
    var Events = (function () {
        function Events() {
        }
        Events.addEventListener = function (obj, evt, fnc) {
...
define('oscillation/../../../src/./utils/extensions',["require", "exports"], function(require, exports) {
    var Extensions = (function () {
        function Extensions() {
        }
        Extensions.init = function () {
...
define('oscillation/../../../src/sketch',["require", "exports", "./pgraphics", "./pmath", "./pvector", "./utils/events", "./utils/extensions"], function(require, exports, __graphics__, __math__, __vector__, __events__, __extensions__) {
    var graphics = __graphics__;
    var math = __math__;
    var vector = __vector__;
    var events = __events__;
...
define('oscillation/angularMotionUsingRotate',["require", "exports", "../../../src/sketch"], function(require, exports, __Sketch__) {
    var Sketch = __Sketch__;

    var AngularMotionUsingRotate = (function (_super) {
        __extends(AngularMotionUsingRotate, _super);
        function AngularMotionUsingRotate() {
            _super.apply(this, arguments);
            this.angle = 0;
            this.aVelocity = 0;
            this.aAcceleration = 0.001;
        }
        AngularMotionUsingRotate.prototype.setup = function () {
        };

        AngularMotionUsingRotate.prototype.draw = function () {
            background(255);
        ...
        return AngularMotionUsingRotate;
    })(Sketch);
...
define('oscillation/mover',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
...
define('oscillation/attractor',["require", "exports", "./mover", "../../../src/pvector"], function(require, exports, __Mover__, __PVector__) {
    var Mover = __Mover__;
    var PVector = __PVector__;
...
define('oscillation/forcesAngularMotion',["require", "exports", "../../../src/sketch", "./mover", "./attractor"], function(require, exports, __Sketch__, __Mover__, __Attractor__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;
    var Attractor = __Attractor__;
...
define('oscillation/mover2',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
...
define('oscillation/pointingDirectionOfMotion',["require", "exports", "../../../src/sketch", "./mover2"], function(require, exports, __Sketch__, __Mover__) {
    var Sketch = __Sketch__;
    var Mover = __Mover__;

    var PointingDirectionOfMotion = (function (_super) {
        __extends(PointingDirectionOfMotion, _super);
        function PointingDirectionOfMotion() {
            _super.apply(this, arguments);
        }
        PointingDirectionOfMotion.prototype.setup = function () {
            this.mover = new Mover();
        };

        PointingDirectionOfMotion.prototype.draw = function () {
            background(255);
        ...
        return PointingDirectionOfMotion;
    })(Sketch);
...
define('oscillation/polarToCartesian',["require", "exports", "../../../src/sketch"], function(require, exports, __Sketch__) {
    var Sketch = __Sketch__;

    var PolarToCartesian = (function (_super) {
        __extends(PolarToCartesian, _super);
        function PolarToCartesian() {
            _super.apply(this, arguments);
        }
        PolarToCartesian.prototype.setup = function () {
            this.r = height * 0.45;
            this.theta = 0;
        };

        PolarToCartesian.prototype.draw = function () {
            translate(width / 2, height / 2);
...
define('oscillation/simpleHarmonicMotion',["require", "exports", "../../../src/sketch"], function(require, exports, __Sketch__) {
    var Sketch = __Sketch__;

    var SimpleHarmonicMotion = (function (_super) {
        __extends(SimpleHarmonicMotion, _super);
        function SimpleHarmonicMotion() {
            _super.apply(this, arguments);
        }
        SimpleHarmonicMotion.prototype.setup = function () {
        };

        SimpleHarmonicMotion.prototype.draw = function () {
            background(255);
...
define('oscillation/oscillator',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
...
define('oscillation/oscillatingObjects',["require", "exports", "../../../src/sketch", "./oscillator"], function(require, exports, __Sketch__, __Oscillator__) {
    var Sketch = __Sketch__;
    var Oscillator = __Oscillator__;

    var OscillatingObjects = (function (_super) {
        __extends(OscillatingObjects, _super);
        function OscillatingObjects() {
            _super.apply(this, arguments);
        }
        OscillatingObjects.prototype.setup = function () {
            this.oscillators = [];
        ...
        OscillatingObjects.prototype.draw = function () {
            background(255);
...
define('oscillation/wave',["require", "exports", "../../../src/sketch"], function(require, exports, __Sketch__) {
    var Sketch = __Sketch__;
...
define('oscillation/pendulum',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
    ...
    var Pendulum = (function () {
        ...
        Pendulum.prototype.drag = function () {
            if (this.dragging) {
                var diff = PVector.sub(this.origin, new PVector(mouseX, mouseY));
...
define('oscillation/swingingPendulum',["require", "exports", "../../../src/sketch", "../../../src/pvector", "./pendulum"], function(require, exports, __Sketch__, __PVector__, __Pendulum__) {
    var Sketch = __Sketch__;
    var PVector = __PVector__;
    var Pendulum = __Pendulum__;

    var SwingingPendulum = (function (_super) {
        __extends(SwingingPendulum, _super);
        function SwingingPendulum() {
            _super.apply(this, arguments);
        }
        SwingingPendulum.prototype.setup = function () {
            this.p = new Pendulum(new PVector(width / 2, height / 2), 175);
        };

        SwingingPendulum.prototype.draw = function () {
            background(255);
            this.p.go();
        };

        SwingingPendulum.prototype.mousePressed = function () {
            this.p.clicked(mouseX, mouseY);
        };

        SwingingPendulum.prototype.mouseReleased = function () {
            this.p.stopDragging();
        };
        return SwingingPendulum;
    })(Sketch);
...
define('oscillation/bob',["require", "exports", "../../../src/pvector"], function(require, exports, __PVector__) {
    var PVector = __PVector__;
...
define('oscillation/spring',["require", "exports", "../../../src/pgraphics", "../../../src/pvector", "./bob"], function(require, exports, __graphics__, __PVector__, __Bob__) {
    var graphics = __graphics__;
    var PVector = __PVector__;
    var Bob = __Bob__;
...
define('oscillation/springConnection',["require", "exports", "../../../src/sketch", "./spring", "../../../src/pvector", "./bob"], function(require, exports, __Sketch__, __Spring__, __PVector__, __Bob__) {
    var Sketch = __Sketch__;
    var Spring = __Spring__;
    var PVector = __PVector__;
    var Bob = __Bob__;

    var SpringConnection = (function (_super) {
        __extends(SpringConnection, _super);
        function SpringConnection() {
            _super.apply(this, arguments);
        }
        SpringConnection.prototype.setup = function () {
            this.spring = new Spring(width / 2, 10, 100);
            this.bob = new Bob(width / 2, 100);
        };

        SpringConnection.prototype.draw = function () {
            background(255);
        ...
        SpringConnection.prototype.mousePressed = function () {
            this.bob.clicked(mouseX, mouseY);
        };

        SpringConnection.prototype.mouseReleased = function () {
...
], function ($, bouncingBall, vectorSubtraction, vectorMultiplication, vectorNormalization, motionVelocity, constantAcceleration, randomAcceleration, accelerateTowardsMouse, multipleAccelerateTowardsMouse, forces, gravityScaledByMass, includingFriction, fluidResistance, attraction, attractionManyMovers, mutualAttraction, angularMotionUsingRotate, forcesAngularMotion, pointingDirectionOfMotion, polarToCartesian, simpleHarmonicMotion, oscillatingObjects, wave, swingingPendulum, springConnection) {
